# test/ref/datagrip_sh_ref.sh — the sh implementation of modules/datagrip.sh, FROZEN.
#
# The last pure-sh version, kept as the specification of what the C module
# (modules/datagrip.c) must do: test/unit/module_c_parity.sh runs both under
