# test/ref/theme_sh_ref.sh — the sh implementation of lib/theme.sh, FROZEN.
#
# The last pure-sh lib/theme.sh, kept verbatim as the specification of what the
# C port (lib/theme.c) must produce: test/unit/theme_c_parity.sh sources
# this file and diffs it against the shim. Nothing in the installer sources it.
#
# --- original -----------------------------------------------------------------
#
