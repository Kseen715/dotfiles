# test/ref/detect_sh_ref.sh — the sh implementation of lib/detect.sh, FROZEN.
#
# The last pure-sh lib/detect.sh, kept verbatim as the specification of what
# the C port (lib/detect.c) must find: test/unit/detect_c_parity.sh runs
# both against this machine AND against stubbed lscpu/lspci/dmidecode fixtures,
# and diffs every variable. Nothing in the installer sources it.
#
# --- original -----------------------------------------------------------------
#
