# test/ref/gnome-focus_sh_ref.sh — the sh implementation of modules/gnome-focus.sh, FROZEN.
#
# The last pure-sh version, kept as the specification of what the C module
# (modules/gnome-focus.c) must do: test/unit/module_c_parity.sh runs both under
