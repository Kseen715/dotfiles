#!/bin/sh
# test/ref/install_sh_ref.sh — the sh implementation of install.sh, FROZEN.
#
# The last pure-sh install.sh, kept verbatim as the specification of what the C
# helper (lib/install.c) must print and decide: test/unit/install_c_parity.sh
# drives both and diffs their bytes. Nothing runs it for real, and it must
# never be "fixed" — a change here is a change to the reference output.
#
# --- original -----------------------------------------------------------------
#
