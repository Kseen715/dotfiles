# test/ref/hyprland_sh_ref.sh — the sh implementation of modules/hyprland.sh, FROZEN.
#
# The last pure-sh version, kept as the specification of what the C module
# (modules/hyprland.c) must do: test/unit/module_c_parity.sh runs both under
