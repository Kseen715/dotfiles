# test/ref/polkit-agent_sh_ref.sh — the sh implementation of modules/polkit-agent.sh, FROZEN.
#
# The last pure-sh version, kept as the specification of what the C module
# (modules/polkit-agent.c) must do: test/unit/module_c_parity.sh runs both under
