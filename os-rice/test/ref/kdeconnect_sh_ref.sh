# test/ref/kdeconnect_sh_ref.sh — the sh implementation of modules/kdeconnect.sh, FROZEN.
#
# The last pure-sh version, kept as the specification of what the C module
# (modules/kdeconnect.c) must do: test/unit/module_c_parity.sh runs both under
...
run_step "Installing KDE Connect" pkg_install kdeconnect
