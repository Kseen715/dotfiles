# test/ref/dnscrypt_sh_ref.sh — the sh implementation of modules/dnscrypt.sh, FROZEN.
#
# The last pure-sh version, kept as the specification of what the C module
# (modules/dnscrypt.c) must do: test/unit/module_c_parity.sh runs both under
