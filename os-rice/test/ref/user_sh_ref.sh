# test/ref/user_sh_ref.sh — the sh implementation of lib/user.sh, FROZEN.
#
# The last pure-sh lib/user.sh, kept verbatim as the specification of what the
# C port (lib/user.c) must decide and produce: test/unit/user_c_parity.sh
# sources this file and diffs it against the shim. Nothing in the installer
# sources it, and it must never be "fixed".
#
# --- original -----------------------------------------------------------------
#
