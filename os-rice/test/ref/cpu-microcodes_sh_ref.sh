# test/ref/cpu-microcodes_sh_ref.sh — the sh implementation of modules/cpu-microcodes.sh, FROZEN.
#
# The last pure-sh version, kept as the specification of what the C module
# (modules/cpu-microcodes.c) must do: test/unit/module_c_parity.sh runs both under
