...
static const char *posix_test_names[] = {
    ...
    "service_test", "preflight_test", "apply_test", "pkg_test", "nerdfont_test", "net_test", "git_test", "reload_test", "migrate_test", "zsh_test", "gnome_test", "gnome_modules_test", "detect_test", "gpu_drivers_test", "audio_test", "swap_test", "log_test", "ui_test", "state_test", "testrun_test", "user_test", "theme_test", "theme_layers_test", "wallpaper_test"
};
