...
DIRECTORIES_TO_INSTALL="$HOME/.config/yazi/flavors"
DIRECTORIES_LOCAL="flavors"

FILES_TO_INSTALL="$HOME/.config/yazi/yazi.toml,$HOME/.config/yazi/theme.toml,$HOME/.config/yazi/package.toml"
FILES_LOCAL="yazi.toml,theme.toml,package.toml"
